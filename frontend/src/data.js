export const CONTENT = {
  es: {
    ...
    dev: {
      ...
      projects: [
        ...
        { tag: "02", title: "Can Cargol", desc: "Website creado para hostear un b'n'b y que las reservas no pasen por Booking o Air b'n'b. A día de hoy más de 200 clientes al año nos contactan a través de ella.", stack: ["React", "Python", "CSS"], linkLabel: "Ver proyecto", link: "#", imgSrc: "/assets/can-cargol-hero.png", imgAlt: "Captura de Can Cargol" }
      ],
  ...
  ca: {
    ...
    dev: {
      ...
      projects: [
        { tag: "01", title: "RecetaIA", desc: "App que suggereix receptes a partir de 4 ingredients que ja tens a casa, mitjançant l'API de ChatGPT.", stack: ["React", "Python", "OpenAI API"], linkLabel: "Veure projecte", link: "#", imgSrc: null, imgAlt: "Captura de RecetaIA" },
